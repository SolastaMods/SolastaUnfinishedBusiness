...
namespace SolastaModApi.Extensions
{
    ...
    /// </summary>
    [TargetType(typeof(GuiEffectDefinition)), GeneratedCode("Community Expansion Extension Generator", "1.0.0")]
    public static partial class GuiEffectDefinitionExtensions
    {
        public static T AddEffectForms<T>(this T entity,  params  EffectForm [ ]  value)
            where T : GuiEffectDefinition
        {
