...
internal static class ValidatorsFeat
{
    ...
    internal static readonly Func<FeatDefinition, RulesetCharacterHero, (bool result, string output)> IsWarlockLevel4 =
        ValidateIsClass(Warlock.FormatTitle(), 4, Warlock);
