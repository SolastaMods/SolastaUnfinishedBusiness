...
internal static class CreditsDisplay
{
    ...
    internal static readonly List<(string, string)> CreditsTable = new()
    {
        ...
        ("HiddenHax",
            "homebrew content design [Path of the Elemental Fury, Path of the Reaver, Path of the Savagery, Oath of Dread, Roguish Arcane Scoundrel, Roguish Duelist, Roguish Slayer, Sorcerous Forceblade, Sorcerous Sorr-Akkath, Martial Weapon Master, Way of the Discordance, Way of the Dragon]"),
        ("Taco",
