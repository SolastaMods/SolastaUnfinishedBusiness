...
internal static class CreditsDisplay
{
    ...
    {
        ("Zappastuff",
            "maintenance, gameplay, feats, fighting styles, invocations, rules, quality of life, Half-elf variants, Blade Dancer, Dead Master, Way of The Silhouette, Multiclass"),
        ("TPABOBAP",
