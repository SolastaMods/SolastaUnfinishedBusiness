...
internal static class DisplaySpellsContext
{
        ...
        params SpellListDefinition[] registeredSpellLists)
    {
        ...
        //Add cantrips to `All Cantrips` list, so that Warlock's `Pact of the Tome` and Loremaster `Arcane Professor` would see them
