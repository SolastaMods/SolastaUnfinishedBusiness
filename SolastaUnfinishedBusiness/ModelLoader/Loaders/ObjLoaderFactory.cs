...
using SolastaUnfinishedBusiness.ModelLoader.TypeParsers;
...
public class ObjLoaderFactory : IObjLoaderFactory
{
    ...
    public IObjLoader Create(IMaterialStreamProvider materialStreamProvider)
    {
        ...
        var materialLibraryLoaderFacade =
            new MaterialLibraryLoaderFacade(materialLibraryLoader, materialStreamProvider);
        ...
        return new ObjLoader(dataStore, faceParser, groupParser, normalParser, textureParser, vertexParser,
