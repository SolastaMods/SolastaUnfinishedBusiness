...
internal class DefensiveStrikeAttack
{
           ...
           GameLocationBattleManager battleManager)
        {
            ...
            damage.bonusDamage += AttributeDefinitions.ComputeAbilityScoreModifier(unit.RulesetCharacter.GetAttribute(AttributeDefinitions.Charisma).CurrentValue) + (unit.RulesetCharacter
                    .GetAttribute(AttributeDefinitions.CharacterLevel).CurrentValue);

            opportunityAttackMode.toHitBonus += AttributeDefinitions.ComputeAbilityScoreModifier(unit.RulesetCharacter.GetAttribute(AttributeDefinitions.Charisma).CurrentValue) + (unit.RulesetCharacter
                    .GetAttribute(AttributeDefinitions.CharacterLevel).CurrentValue);

            CharacterActionParams temp2 = new CharacterActionParams(
                defender,
