...
public static class NetworkingManagerPatcher
{
    ...
    {
        private static void CreateRoom(string name, RoomOptions roomOptions, TypedLobby typedLobby)
        {
        ...
        public static IEnumerable<CodeInstruction> Transpiler([NotNull] IEnumerable<CodeInstruction> instructions)
        {
            ...
            var myCreateRoomMethod = new Action<string, RoomOptions, TypedLobby>(CreateRoom).Method;
