...
public static class CharacterActionItemFormPatcher
{
    ...
    public static class Bind_Patch
    {
        public static void Postfix(CharacterActionItemForm __instance)
        {
            ...
            if (__instance.guiCharacterAction.forcedAttackMode == null) { return;}
            
            __instance.dynamicItemPropertiesEnumerator.Unbind();
            __instance.dynamicItemPropertiesEnumerator.Bind(__instance.guiCharacterAction.forcedAttackMode.sourceObject as RulesetItem);
        }
    }
}
