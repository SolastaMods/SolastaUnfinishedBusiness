...
public static class EffectFormPatcher
{
    ...
    [UsedImplicitly]
    public static class Damage_Getter_Patch
    {
        [UsedImplicitly]
    ...
    [SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "Patch")]
    [UsedImplicitly]
    public static class Healing_Getter_Patch
    {
        [UsedImplicitly]
    ...
    [SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "Patch")]
    [UsedImplicitly]
    public static class Condition_Getter_Patch
    {
        [UsedImplicitly]
    ...
    [SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "Patch")]
    [UsedImplicitly]
    public static class LightSource_Getter_Patch
    {
        [UsedImplicitly]
    ...
    [SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "Patch")]
    [UsedImplicitly]
    public static class Summon_Getter_Patch
    {
        [UsedImplicitly]
    ...
    [SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "Patch")]
    [UsedImplicitly]
    public static class Counter_Getter_Patch
    {
        [UsedImplicitly]
    ...
    [SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "Patch")]
    [UsedImplicitly]
    public static class TemporaryHitPoints_Getter_Patch
    {
        [UsedImplicitly]
    ...
    [SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "Patch")]
    [UsedImplicitly]
    public static class Motion_Getter_Patch
    {
        [UsedImplicitly]
    ...
    [SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "Patch")]
    [UsedImplicitly]
    public static class SpellSlots_Getter_Patch
    {
        [UsedImplicitly]
    ...
    [SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "Patch")]
    [UsedImplicitly]
    public static class Divination_Getter_Patch
    {
        [UsedImplicitly]
    ...
    [SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "Patch")]
    [UsedImplicitly]
    public static class ItemProperty_Getter_Patch
    {
        [UsedImplicitly]
    ...
    [SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "Patch")]
    [UsedImplicitly]
    public static class Alteration_Getter_Patch
    {
        [UsedImplicitly]
    ...
    [SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "Patch")]
    [UsedImplicitly]
    public static class Topology_Getter_Patch
    {
        [UsedImplicitly]
    ...
    [SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "Patch")]
    [UsedImplicitly]
    public static class Revive_Getter_Patch
    {
        [UsedImplicitly]
    ...
    [SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "Patch")]
    [UsedImplicitly]
    public static class Kill_Getter_Patch
    {
        [UsedImplicitly]
    ...
    [SuppressMessage("Minor Code Smell", "S101:Types should be named in PascalCase", Justification = "Patch")]
    [UsedImplicitly]
    public static class ShapeChange_Getter_Patch
    {
        [UsedImplicitly]
