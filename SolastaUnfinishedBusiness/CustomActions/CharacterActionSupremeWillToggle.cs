...
public class CharacterActionSupremeWillToggle : CharacterAction
#pragma warning restore CA1050
{
    private const ActionDefinitions.Id Action = (ActionDefinitions.Id)ExtraActionId.SupremeWillToggle;

    public CharacterActionSupremeWillToggle(CharacterActionParams actionParams) : base(actionParams)
    {
    }
