...
namespace SolastaCommunityExpansion.Displays
{
    internal static class GameServicesDisplay
    {
        private static readonly Dictionary<string, Func<object>> TARGET_LIST = new()
        {
            ...
            {
                "IGameLocationEnvironmentService",
            ...
            {
                "IGameLocationPathfindingService",
                () => ServiceRepository.GetService<IGameLocationPathfindingService>()
            },
            {
                "IGameLocationPositioningService",
