    ...
    public static List<MonsterContext.CustomMonster> Definitions = new()
    {
        ...
        new MonsterContext.CustomMonster
        {
            ...
            AttackIterations =
                new List<MonsterAttackIteration>
                {
                    MonstersAttributes.BalorWhipAttackIteration, MonstersAttributes.BalorLongswordAttackIteration
                },
            LegendaryActionOptions = new List<LegendaryActionDescription>(),
        ...
        new MonsterContext.CustomMonster
        {
            ...
            SpriteReference = DatabaseHelper
                .GetDefinition<HumanoidMonsterPresentationDefinition>("NPC_Presentation_Emtan_Ghost",
                    "dc25835cf4091f44795493498e2eb79e")
        ...
        new MonsterContext.CustomMonster
        {
            ...
            AttackIterations =
                new List<MonsterAttackIteration>
                {
                    MonstersAttributes.SolarLongswordAttackIteration, MonstersAttributes.SolarLongbowAttackIteration
                },
            LegendaryActionOptions =
                new List<LegendaryActionDescription>
                {
