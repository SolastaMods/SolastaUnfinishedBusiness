...
#pragma warning restore S3011 // Reflection should not be used to increase accessibility of classes, methods, or fields
        ...
        protected DefinitionBuilder(string name, bool createGuiPresentation = true)
        ...
        /// <param name="name"></param>
        /// <param name="createGuiPresentation"></param>
        protected DefinitionBuilder(TDefinition original, string name, bool createGuiPresentation = true)
        ...
        protected DefinitionBuilder(TDefinition original)
        {
            Preconditions.IsNotNull(original, nameof(original));
            Definition = original;
        }
