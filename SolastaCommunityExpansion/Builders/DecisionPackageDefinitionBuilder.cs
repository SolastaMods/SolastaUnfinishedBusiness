...
public class
    DecisionPackageDefinitionBuilder : DefinitionBuilder<DecisionPackageDefinition,
        DecisionPackageDefinitionBuilder>
{
    #region Constructors
    ...
    protected DecisionPackageDefinitionBuilder(DecisionPackageDefinition original, string name,
