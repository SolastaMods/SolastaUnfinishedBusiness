...
public static class ReachMeleeTargeting
{
        ...
        RulesetAttackMode attackMode)
    {
        ...
        var validDestinations = cursor.GetField<List<GameLocationCharacterDefinitions.PathStep>>("validDestinations");
        ...
        var current = new GameLocationCharacterDefinitions.PathStep
        {
            moveCost = 99999
        };
