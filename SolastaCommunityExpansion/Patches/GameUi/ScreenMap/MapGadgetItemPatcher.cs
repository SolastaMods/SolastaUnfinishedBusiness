    ...
    internal static class MapGadgetItem_Bind
    {
            ...
            Sprite[] ___backgroundSprites)
        {
            ...
            switch ((int)itemType)
            {
                ...
                case -2:
                    ___backgroundImage.sprite = ___backgroundSprites[2];
                    ___iconImage.sprite = CustomIcons.GetOrCreateSprite("Entrance", Resources.Entry, 24);
                    ___guiTooltip.Content = "Exit";
                    break;
                case -3:
                    ___backgroundImage.sprite = ___backgroundSprites[2];
                    ___iconImage.sprite = CustomIcons.GetOrCreateSprite("Teleport", Resources.Teleport, 24);
