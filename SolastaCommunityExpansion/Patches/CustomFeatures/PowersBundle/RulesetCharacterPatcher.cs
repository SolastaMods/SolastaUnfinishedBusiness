...
internal static class Helper
{
        ...
        IEnumerable<FeatureDefinitionPower> powers)
    {
        ...
        foreach (var power in powers)
        {
            ...
            foreach (var subPower in bundles.Select(masterPower => PowerBundleContext.GetBundle(masterPower)).Where(bundle => bundle.TerminateAll).SelectMany(bundle => bundle.SubPowers))
            {
