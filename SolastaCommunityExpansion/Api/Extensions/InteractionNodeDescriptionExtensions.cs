...
namespace SolastaModApi.Extensions
{
    ...
    /// </summary>
    [TargetType(typeof(InteractionNodeDescription)), GeneratedCode("Community Expansion Extension Generator", "1.0.0")]
    public static partial class InteractionNodeDescriptionExtensions
    {
        ...
        public static T SetPosition<T>(this T entity, UnityEngine.Vector2 value)
            where T : InteractionNodeDescription
        {
