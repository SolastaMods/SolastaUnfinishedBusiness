...
namespace SolastaModApi.Extensions
{
    ...
    public static class FeatureDefinitionHealingModifierExtensions
    {
        ...
        public static T SetAdvantageOnHitDieSpending<T>(this T entity, Boolean value)
            where T : FeatureDefinitionHealingModifier
        {
        ...
        public static T SetCannotGainHitPoints<T>(this T entity, Boolean value)
            where T : FeatureDefinitionHealingModifier
        {
        ...
        public static T SetHealingBonusDiceNumber<T>(this T entity, Int32 value)
            where T : FeatureDefinitionHealingModifier
        {
        ...
        public static T SetHealSelfHealsKindred<T>(this T entity, Boolean value)
            where T : FeatureDefinitionHealingModifier
        {
        ...
        public static T SetHealsSelfWhenCastingHealingSpell<T>(this T entity, Boolean value)
            where T : FeatureDefinitionHealingModifier
        {
        ...
        public static T SetHitDiceHealsKindred<T>(this T entity, Boolean value)
            where T : FeatureDefinitionHealingModifier
        {
        ...
        public static T SetMaximizeReceivedHealing<T>(this T entity, Boolean value)
            where T : FeatureDefinitionHealingModifier
        {
        ...
        public static T SetSelfHealingDiceNumber<T>(this T entity, Int32 value)
            where T : FeatureDefinitionHealingModifier
        {
