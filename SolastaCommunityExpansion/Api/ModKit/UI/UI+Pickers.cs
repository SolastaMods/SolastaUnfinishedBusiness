...
public static partial class UI
{
    ...
    public static bool SelectionGrid(ref int selected, string[] texts, int xCols, int maxColsIfNarrow = 4,
    ...
    public static void EnumGrid<TEnum>(Func<TEnum> get, Action<TEnum> set, int xCols,
    ...
    public static NamedFunc<T> TypePicker<T>(string title, ref int selectedIndex, NamedFunc<T>[] items)
        where T : class
    {
    ...
    {
        return GridPicker(title, ref selected, items, unselectedTitle, titler, ref searchText, 6, buttonStyle,
            options);
    }
