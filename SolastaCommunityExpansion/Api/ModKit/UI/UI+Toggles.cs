...
namespace ModKit {
    ...
    public static partial class UI {
        ...
        // ZAPPASTUFF: keep same interface
        [Obsolete]
        public static bool Toggle(string title, ref bool value, Single width, params GUILayoutOption[] options)
        {
            options = options.AddDefaults();
            var changed = false;
            if (Private.UI.CheckBox(title, value, false, toggleStyle, options)) { value = !value; changed = true; }
        ...
        [Obsolete]
        public static bool Toggle(string title, ref bool value, int width, params GUILayoutOption[] options)
        {
            options = options.AddDefaults();
            var changed = false;
            if (Private.UI.CheckBox(title, value, false, toggleStyle, options)) { value = !value; changed = true; }
        ...
        [Obsolete]
        public static bool Toggle(string title, ref bool value, float pixelsPerColumn)
        {
            var changed = false;
            if (Private.UI.CheckBox(title, value, false, toggleStyle, UI.Width(pixelsPerColumn))) { value = !value; changed = true; }
            return changed;
        }
        // ZAPPASTUFF: END
