...
namespace SolastaCommunityExpansion.Viewers.Displays
{
    internal static class SubClassesDisplay
    {
        ...
        internal static void DisplaySubclasses()
        {
            ...
            if (UI.Toggle("Enable short rest recharge of ".white() + "Arcane Weapon".orange() + " on Wizard Arcane Fighter\n".white(), ref toggle, UI.AutoWidth()))
            {
            ...
            UI.Label("");
            UI.Label("Override Rogue Con Artist ".white() + "Improved Manipulation".orange() + " Spell DC".white());
            ...
            UI.Label("");
            UI.Label("Override Wizard Master Manipulator ".white() + "Arcane Manipulation".orange() + " Spell DC".white());
