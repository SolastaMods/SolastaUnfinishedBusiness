...
namespace SolastaCommunityExpansion.Classes.Warlock.Subclasses
{
    public static class DHWarlockSubclassToadKingPatron
    {
        public static CharacterSubclassDefinition Build()
        {
            ...
            FeatureDefinitionMovementAffinity ToadKingMovementAffinityJump = new FeatureDefinitionMovementAffinityBuilder
                 (MovementAffinityJump, "ToadKingMovementAffinityJump", DefinitionBuilder.CENamespaceGuid)
                 .AddToDB();
            ToadKingMovementAffinityJump.GuiPresentation.SetTitle("Feature/&ToadKingJumpTitle");

            FeatureDefinitionMovementAffinity ToadKingMovementAffinitySpiderClimb =new FeatureDefinitionMovementAffinityBuilder
                 (MovementAffinitySpiderClimb, "ToadKingMovementAffinitySpiderClimb", DefinitionBuilder.CENamespaceGuid)
                 .AddToDB();
