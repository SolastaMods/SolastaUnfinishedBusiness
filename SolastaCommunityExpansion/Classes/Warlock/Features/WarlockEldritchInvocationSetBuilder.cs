...
namespace SolastaCommunityExpansion.Classes.Warlock.Features
{
    ...
    internal class WarlockEldritchInvocationSetBuilderLevel7 : FeatureDefinitionFeatureSetBuilder
    {
        ...
        protected WarlockEldritchInvocationSetBuilderLevel7(string name) : base(WarlockFeatures.WarlockEldritchInvocationSetLevel5, name, DefinitionBuilder.CENamespaceGuid)
        {
    ...
    internal class WarlockEldritchInvocationSetBuilderLevel9 : FeatureDefinitionFeatureSetBuilder
    {
        ...
        protected WarlockEldritchInvocationSetBuilderLevel9(string name) : base(WarlockFeatures.WarlockEldritchInvocationSetLevel5, name, DefinitionBuilder.CENamespaceGuid)
        {
            Definition.GuiPresentation.Title = "Feature/&ClassWarlockEldritchInvocationSetLevelTitle";
            Definition.GuiPresentation.Description = "Feature/&ClassWarlockEldritchInvocationSetLevelDescription";
    ...
    internal class WarlockEldritchInvocationSetBuilderLevel12 : FeatureDefinitionFeatureSetBuilder
    {
        ...
        protected WarlockEldritchInvocationSetBuilderLevel12(string name) : base(WarlockFeatures.WarlockEldritchInvocationSetLevel5, name, DefinitionBuilder.CENamespaceGuid)
        {
            Definition.GuiPresentation.Title = "Feature/&ClassWarlockEldritchInvocationSetLevelTitle";
            Definition.GuiPresentation.Description = "Feature/&ClassWarlockEldritchInvocationSetLevelDescription";
    ...
    internal class WarlockEldritchInvocationSetBuilderLevel15 : FeatureDefinitionFeatureSetBuilder
    {
        ...
        protected WarlockEldritchInvocationSetBuilderLevel15(string name) : base(WarlockFeatures.WarlockEldritchInvocationSetLevel5, name, DefinitionBuilder.CENamespaceGuid)
        {
            Definition.GuiPresentation.Title = "Feature/&ClassWarlockEldritchInvocationSetLevelTitle";
            Definition.GuiPresentation.Description = "Feature/&ClassWarlockEldritchInvocationSetLevelDescription";
    ...
    internal class WarlockEldritchInvocationSetBuilderLevel18 : FeatureDefinitionFeatureSetBuilder
    {
        ...
        protected WarlockEldritchInvocationSetBuilderLevel18(string name) : base(WarlockFeatures.WarlockEldritchInvocationSetLevel5, name, DefinitionBuilder.CENamespaceGuid)
        {
            Definition.GuiPresentation.Title = "Feature/&ClassWarlockEldritchInvocationSetLevelTitle";
            Definition.GuiPresentation.Description = "Feature/&ClassWarlockEldritchInvocationSetLevelDescription";
