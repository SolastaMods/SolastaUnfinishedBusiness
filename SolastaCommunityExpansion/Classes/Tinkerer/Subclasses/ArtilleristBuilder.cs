...
#pragma warning restore IDE0060, RCS1163 // Unused parameter.
        {
            ...
            var flameAttack = new FeatureDefinitionPowerBuilder("ArtilleristFlameCannonAttack", TinkererClass.GuidNamespace,
            ...
            // TODO- add an option to enable the power version of the Blaster (there have been some requests for this) instead of the summons
            var forceAttack = new FeatureDefinitionPowerBuilder("ArtilleristForceCannonAttack", TinkererClass.GuidNamespace,
            ...
            // TODO- add an option to enable the power version of the Blaster (there have been some requests for this) instead of the summons
            var protectorActivation = new FeatureDefinitionPowerBuilder("ArtilleristProtectorCannonAttack", TinkererClass.GuidNamespace,
            ...
            var arcaneFirearm = new FeatureDefinitionAdditionalDamageBuilder("ArtificerArtilleristArcaneFirearm",
...
#pragma warning disable IDE0059, S1481 // Unused local variables should be removed
            var artilleristDetonationSpell = Builders.Features.FeatureDefinitionAutoPreparedSpellsBuilder
...
#pragma warning restore IDE0059, S1481 // Unused local variables should be removed
            ...
            // TODO- add an option to enable the power version of the Blaster (there have been some requests for this) instead of the summons
            var flame9Attack = new FeatureDefinitionPowerBuilder("ArtilleristFlame9CannonAttack", TinkererClass.GuidNamespace,
            ...
            // TODO- add an option to enable the power version of the Blaster (there have been some requests for this) instead of the summons
            var force9Attack = new FeatureDefinitionPowerBuilder("ArtilleristForceCannon9Attack", TinkererClass.GuidNamespace,
                1, UsesDetermination.AbilityBonusPlusFixed, AttributeDefinitions.Intelligence,
...
#pragma warning disable S1481, IDE0059 // Unused local variables should be removed
            var flame15Attack = new FeatureDefinitionPowerBuilder("ArtilleristFlame15CannonAttack", TinkererClass.GuidNamespace,
...
#pragma warning restore S1481, IDE0059 // Unused local variables should be removed
            ...
            // TODO- add an option to enable the power version of the Blaster (there have been some requests for this) instead of the summons
#pragma warning disable S1481, IDE0059 // Unused local variables should be removed
            var force15Attack = new FeatureDefinitionPowerBuilder("ArtilleristForceCannon15Attack", TinkererClass.GuidNamespace,
...
#pragma warning restore S1481, IDE0059 // Unused local variables should be removed
            ...
            // TODO- add an option to enable the power version of the Blaster (there have been some requests for this) instead of the summons
#pragma warning disable S1481, IDE0059 // Unused local variables should be removed
            var protector15Activation = new FeatureDefinitionPowerBuilder("ArtilleristProtector15CannonAttack", TinkererClass.GuidNamespace,
...
#pragma warning restore S1481, IDE0059 // Unused local variables should be removed
            ...
            var artilleryConstructLevel15AutopreparedSpells = Builders.Features.FeatureDefinitionAutoPreparedSpellsBuilder
