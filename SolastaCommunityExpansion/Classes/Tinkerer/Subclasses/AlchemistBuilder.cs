...
namespace SolastaCommunityExpansion.Classes.Tinkerer.Subclasses
{
    public static class AlchemistBuilder
    {
        public static CharacterSubclassDefinition Build(CharacterClassDefinition artificer)
        {
            ...
            var swiftness = BuildCondition("AlchemistSwiftnessElixirCondition", DurationType.Hour, 1, false, swiftnessGui,
                BuildMovementAffinity("AlchemistSwiftnessMovementAffinity", true, 2, 1, swiftnessGui));
            var cancelSwiftness = new CancelConditionPowerBuilder("CancelElixirSwiftness", "86888f66-c8b2-49db-910a-bde389dd69df",
            ...
            var resilience = BuildCondition("AlchemistResilienceElixirCondition", DurationType.Minute, 10, false, resilienceGui,
                ...
                1, resilienceGui));
            var cancelResilience = new CancelConditionPowerBuilder("CancelElixirResilience", "4de693d2-f193-4434-8741-57335d7cefdc",
            ...
            var alchemicalSavantSpells = BuildMagicAffinityHeightenedList(new List<string>() {
                AcidArrow.Name,
                FlamingSphere.Name,
            }, 2,
