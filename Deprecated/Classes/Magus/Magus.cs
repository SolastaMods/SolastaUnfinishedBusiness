...
using SolastaUnfinishedBusiness.Classes.Magus.Subclasses;
...
using static SolastaUnfinishedBusiness.Api.DatabaseHelper.SkillDefinitions;
using static RuleDefinitions;

namespace SolastaUnfinishedBusiness.Classes.Magus;
