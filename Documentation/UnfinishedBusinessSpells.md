...
# 25. - Infernal Smite (V) level 1 Evocation [Concentration]
...
# 26. - Intensify Gravity (V,S) level 1 Transmutation

Sharply increase gravity in a 10-foot-radius sphere to crush and slow targets.

# 27. - Mule (V,S) level 1 Transmutation
...
# 28. - Radiant Motes (V,S) level 1 Evocation
...
# 29. - Sanctuary (V,S) level 1 Abjuration
...
# 32. - Summon Familiar (V,S) level 1 Conjuration
...
# 33. - Swift Strike (V) level 1 Transmutation [Concentration]
...
# 34. - Vile Brew (V,S) level 1 Evocation [Concentration]
...
# 35. - Void's Grasp (V,S) level 1 Evocation
