...
# 32. - Vile Brew (V,S) level 1 Evocation [Concentration]
...
# 33. - Void's Grasp (V,S) level 1 Evocation
...
# 34. - Wrathful Smite (V) level 1 Evocation [Concentration]
...
# 35. - Bounden Ice (S) level 2 Evocation
...
# 36. - Color Burst (V,S) level 2 Illusion
...
# 37. - Mirror Image (V,S) level 2 Illusion
...
# 38. - Noxious Spray (V,S) level 2 Evocation
...
# 39. - Petal Storm (V,S) level 2 Conjuration [Concentration]
...
# 40. - Protect Threshold (V,S) level 2 Abjuration
...
# 41. - Psychic Whip (V) level 2 Enchantment
...
# 42. - Raise Skeleton (V,S) level 2 Necromancy [Concentration]
...
# 43. - Raise Skeleton Archer (V,S) level 2 Necromancy [Concentration]

Summons Skeleton Archer:
Skeletons are animated by dark magic. They used to be living creatures but are now empty shells of hate, arisen from tombs or battlefields and craving for life… to kill.

# 44. - Shadow Blade (V,S) level 2 Illusion [Concentration]

You weave together threads of shadow to create a sword of solidified gloom in your hand.

# 45. - Web (V,S) level 2 Conjuration [Concentration]
...
# 46. - Adder's Fangs (V,S) level 3 Conjuration
...
# 47. - Blinding Smite (V) level 3 Evocation [Concentration]
...
# 48. - Booming Step (V) level 3 Conjuration
...
# 49. - Corrupting Bolt (V,S) level 3 Necromancy
...
# 50. - Crusader's Mantle (V) level 3 Evocation [Concentration]

Surround yourself with a magical aura. Allies within the aura gain a bonus 1d4 radiant damage on their attacks.

# 51. - Elemental Weapon (V,S) level 3 Transmutation [Concentration]
...
# 52. - Flame Arrows (M,V,S) level 3 Transmutation [Concentration]
...
# 53. - Lightning Arrow (V,S) level 3 Transmutation [Concentration]
...
# 54. - Pulse Wave (V,S) level 3 Evocation

Hurl enemies away with intense gravitational pressure.

# 55. - Raise Ghoul (V,S) level 3 Necromancy [Concentration]

Summons Ghoul:
A ravenous undead creature, constantly searching for flesh to eat.

# 56. - Spirit Shroud (V,S) level 3 Necromancy [Concentration]
...
# 57. - Vitality Transfer (V,S) level 3 Necromancy
...
# 58. - Winter's Breath (V,S) level 3 Conjuration

Create a blast of cold wind to chill your enemies and knock them prone.

# 59. - Aura of Perseverance (V) level 4 Abjuration [Concentration]
...
# 60. - Aura of Vivacity (V) level 4 Abjuration [Concentration]
...
# 61. - Brain Bulwark (V) level 4 Abjuration
...
# 62. - Gravity Sinkhole (V,S) level 4 Evocation
...
# 63. - Protector of the Wild (V) level 4 Transmutation [Concentration]
...
# 64. - Psychic Lance (V) level 4 Enchantment
...
# 65. - Raise Skeletal Enforcer (V,S) level 4 Necromancy [Concentration]

Summons Skeletal Enforcer:
A powerful undead creature armed with an axe and a shield.

# 66. - Staggering Smite (V) level 4 Evocation [Concentration]
...
# 67. - Banishing Smite (V) level 5 Abjuration [Concentration]
...
# 68. - Divine Wrath (V) level 5 Evocation
...
# 69. - Far Step (V) level 5 Conjuration
...
# 70. - Incineration (V) level 5 Evocation [Concentration]
...
# 71. - Magical Negation (V) level 5 Abjuration [Concentration]
...
# 72. - Mantle of Thorns (V,S) level 5 Transmutation [Concentration]
...
# 73. - Raise Skeletal Knight (V,S) level 5 Necromancy [Concentration]

Summons Skeletal Knight:
A powerful undead creature, created by raising a dead knight.

# 74. - Raise Skeletal Marksman (V,S) level 5 Necromancy [Concentration]
...
# 76. - Steel Whirlwind (M,S) level 5 Conjuration
