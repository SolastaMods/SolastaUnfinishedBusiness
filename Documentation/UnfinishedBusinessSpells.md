...
# 2. - Air Blast (V,S) level 0 Transmutation

Fire a blast of focused air at your target.

# 3. - Blade Ward (V,S) level 0 Abjuration

You extend your hand and trace a sigil of warding in the air. Until the end of your next turn, you have resistance against bludgeoning, piercing, and slashing damage dealt by weapon attacks.

# 4. - Booming Blade (M,S) level 0 Evocation
...
# 5. - Burning Blade (M,S) level 0 Evocation
...
# 11. - Minor Lifesteal (V,S) level 0 Necromancy
...
# 17. - Caustic Zap (V,S) level 1 Evocation
...
# 18. - Celerity Boon (V,S) level 1 Divination

You touch a willing creature. For the duration, the target can add 1d8 to its initiative rolls.

# 19. - Chromatic Orb (M,V,S) level 1 Evocation
...
# 21. - Ensnaring Strike (V) level 1 Conjuration [Concentration]
...
# 22. - Find Familiar (V,S) level 1 Conjuration
...
# 27. - Searing Smite (V) level 1 Evocation [Concentration]
...
# 29. - Spike Barrage (V) level 1 Conjuration [Concentration]

The next time you hit a creature with a ranged weapon attack before the spell ends, this spell creates a rain of thorns that sprouts from your ranged weapon or ammunition. In addition to the normal effect of the attack, the target of the attack and each creature within 5 feet of it must make a Dexterity saving throw. A creature takes 1d10 piercing damage on a failed save, or half as much damage on a successful one.

# 30. - Swift Strike (V) level 1 Transmutation [Concentration]
...
# 31. - Thunderous Smite (V) level 1 Evocation [Concentration]
...
# 32. - Void's Grasp (V,S) level 1 Evocation
...
# 33. - Wrathful Smite (V) level 1 Evocation [Concentration]
...
# 34. - Bounden Ice (S) level 2 Evocation
...
# 35. - Color Burst (V,S) level 2 Illusion
...
# 36. - Mirror Image (V,S) level 2 Illusion
...
# 39. - Protect Threshold (V,S) level 2 Abjuration
...
# 40. - Psychic Whip (V) level 2 Enchantment
...
# 41. - Raise Skeleton (V,S) level 2 Necromancy [Concentration]
...
# 42. - Raise Skeleton Archer (V,S) level 2 Necromancy [Concentration]

Summons Skeleton Archer:
Skeletons are animated by dark magic. They used to be living creatures but are now empty shells of hate, arisen from tombs or battlefields and craving for life… to kill.

# 43. - Shadow Blade (V,S) level 2 Illusion [Concentration]

You weave together threads of shadow to create a sword of solidified gloom in your hand.

# 44. - Web (V,S) level 2 Conjuration [Concentration]
...
# 45. - Blinding Smite (V) level 3 Evocation [Concentration]
...
# 46. - Booming Step (V) level 3 Conjuration
...
# 47. - Corrupting Bolt (V,S) level 3 Necromancy

You can fire a pulse of necrotic energy that causes a creature's body to begin to wither and decay. Make a ranged attack against a creature. On a hit, the target takes 4d8 necrotic damage and must succeed a Constitution saving throw. On a failed saving throw, that creature suffers 2x damage to the next attack roll against it until the end of your next turn as its body is corrupted by necrotic magic. When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d8 for each slot level above 3rd.

# 48. - Crusader's Mantle (V) level 3 Evocation [Concentration]

Surround yourself with a magical aura. Allies within the aura gain a bonus 1d4 radiant damage on their attacks.

# 49. - Elemental Weapon (V,S) level 3 Transmutation [Concentration]
...
# 50. - Flame Arrows (M,V,S) level 3 Transmutation [Concentration]
...
# 51. - Lightning Arrow (V,S) level 3 Transmutation [Concentration]
...
# 52. - Pulse Wave (V,S) level 3 Evocation

Hurl enemies away with intense gravitational pressure.

# 53. - Raise Ghoul (V,S) level 3 Necromancy [Concentration]

Summons Ghoul:
A ravenous undead creature, constantly searching for flesh to eat.

# 54. - Spirit Shroud (V,S) level 3 Necromancy [Concentration]
...
# 55. - Vitality Transfer (V,S) level 3 Necromancy
...
# 56. - Winter's Breath (V,S) level 3 Conjuration

Create a blast of cold wind to chill your enemies and knock them prone.

# 57. - Aura of Perseverance (V) level 4 Abjuration [Concentration]
...
# 58. - Aura of Vivacity (V) level 4 Abjuration [Concentration]
...
# 59. - Brain Bulwark (V) level 4 Abjuration
...
# 60. - Gravity Sinkhole (V,S) level 4 Evocation
...
# 61. - Protector of the Wild (V) level 4 Transmutation [Concentration]
...
# 62. - Psychic Lance (V) level 4 Enchantment
...
# 63. - Raise Skeletal Enforcer (V,S) level 4 Necromancy [Concentration]

Summons Skeletal Enforcer:
A powerful undead creature armed with an axe and a shield.

# 64. - Staggering Smite (V) level 4 Evocation [Concentration]
...
# 65. - Banishing Smite (V) level 5 Abjuration [Concentration]
...
# 66. - Divine Wrath (V) level 5 Evocation
...
# 67. - Far Step (V) level 5 Conjuration
...
# 68. - Incineration (V) level 5 Evocation [Concentration]
...
# 69. - Magical Negation (V) level 5 Abjuration [Concentration]
...
# 70. - Mantle of Thorns (V,S) level 5 Transmutation [Concentration]
...
# 74. - Steel Whirlwind (M,S) level 5 Conjuration
...
# 75. - Heroic Infusion (V,S) level 6 Transmutation [Concentration]
...
# 76. - Poison Wave (M,V,S) level 6 Evocation
...
# 77. - Raise Spectral Avenger (V,S) level 6 Necromancy [Concentration]

Summons Spectral Avenger:
A powerful, ethereal undead creature.

# 78. - Ring of Blades (M,V,S) level 6 Conjuration [Concentration]
...
# 79. - Raise Wight (V,S) level 7 Necromancy [Concentration]

Summons Wight:
A Wight

# 80. - Reverse Gravity (V,S) level 7 Transmutation [Concentration]

This spell reverses gravity in a 50-foot-radius, 100-foot-high cylinder centered on a point within range.

# 81. - Mind Blank (V,S) level 8 Transmutation
...
# 82. - Raise Wight Lord (V,S) level 8 Necromancy [Concentration]

Summons Wight Lord:
A powerful wight, trained to withstand the light of day.

# 83. - Foresight (V,S) level 9 Transmutation

You touch a willing creature and bestow a limited ability to see into the immediate future. For the duration, the target can't be surprised and has advantage on attack rolls, ability checks, and saving throws. Additionally, other creatures have disadvantage on attack rolls against the target for the duration.

# 84. - Mass Heal (V,S) level 9 Transmutation
...
# 85. - Meteor Swarm [Single Target] (V,S) level 9 Transmutation
...
# 86. - Power Word Heal (V,S) level 9 Enchantment

A wave of healing energy washes over the creature you touch. The target regains all its hit points. If the creature is charmed, frightened, paralyzed, or stunned, the condition ends. If the creature is prone, it can use its reaction to stand up. This spell has no effect on undead or constructs.

# 87. - Power Word Kill (V,S) level 9 Transmutation

You utter a word of power that can compel one creature you can see within range to die instantly. If the creature you choose has 100 hit points or fewer, it dies. Otherwise, the spell has no effect.

# 88. - Shapechange (M,V,S) level 9 Transmutation [Concentration]
...
# 89. - Time Stop (V) level 9 Transmutation

You briefly stop the flow of time for everyone but yourself. No time passes for other creatures, while you take 1d4 + 1 turns in a row, during which you can use actions and move as normal.

# 90. - Weird (V,S) level 9 Illusion [Concentration]
