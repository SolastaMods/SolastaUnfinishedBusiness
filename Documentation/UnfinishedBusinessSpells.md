...
# 37. - Petal Storm (V,S) level 2 Conjuration [Concentration]
...
# 38. - Protect Threshold (V,S) level 2 Abjuration
...
# 39. - Psychic Whip (V) level 2 Enchantment
...
# 40. - Raise Skeleton (V,S) level 2 Necromancy [Concentration]
...
# 41. - Raise Skeleton Archer (V,S) level 2 Necromancy [Concentration]

Summons Skeleton Archer:
Skeletons are animated by dark magic. They used to be living creatures but are now empty shells of hate, arisen from tombs or battlefields and craving for life… to kill.

# 42. - Shadow Blade (V,S) level 2 Illusion [Concentration]

You weave together threads of shadow to create a sword of solidified gloom in your hand.

# 43. - Web (V,S) level 2 Conjuration [Concentration]
...
# 44. - Blinding Smite (V) level 3 Evocation [Concentration]
...
# 45. - Booming Step (V) level 3 Conjuration
...
# 46. - Corrupting Bolt (V,S) level 3 Necromancy
...
# 47. - Crusader's Mantle (V) level 3 Evocation [Concentration]

Surround yourself with a magical aura. Allies within the aura gain a bonus 1d4 radiant damage on their attacks.

# 48. - Elemental Weapon (V,S) level 3 Transmutation [Concentration]
...
# 49. - Flame Arrows (M,V,S) level 3 Transmutation [Concentration]
...
# 50. - Lightning Arrow (V,S) level 3 Transmutation [Concentration]
...
# 51. - Pulse Wave (V,S) level 3 Evocation

Hurl enemies away with intense gravitational pressure.

# 52. - Raise Ghoul (V,S) level 3 Necromancy [Concentration]

Summons Ghoul:
A ravenous undead creature, constantly searching for flesh to eat.

# 53. - Spirit Shroud (V,S) level 3 Necromancy [Concentration]
...
# 54. - Winter's Breath (V,S) level 3 Conjuration

Create a blast of cold wind to chill your enemies and knock them prone.

# 55. - Aura of Perseverance (V) level 4 Abjuration [Concentration]
...
# 56. - Aura of Vivacity (V) level 4 Abjuration [Concentration]
...
# 57. - Brain Bulwark (V) level 4 Abjuration
...
# 58. - Gravity Sinkhole (V,S) level 4 Evocation
...
# 59. - Protector of the Wild (V) level 4 Transmutation [Concentration]
...
# 60. - Psychic Lance (V) level 4 Enchantment
...
# 61. - Raise Skeletal Enforcer (V,S) level 4 Necromancy [Concentration]

Summons Skeletal Enforcer:
A powerful undead creature armed with an axe and a shield.

# 62. - Staggering Smite (V) level 4 Evocation [Concentration]
...
# 63. - Banishing Smite (V) level 5 Abjuration [Concentration]
...
# 64. - Divine Wrath (V) level 5 Evocation
...
# 65. - Far Step (V) level 5 Conjuration
...
# 66. - Incineration (V) level 5 Evocation [Concentration]
...
# 67. - Magical Negation (V) level 5 Abjuration [Concentration]
...
# 68. - Mantle of Thorns (V,S) level 5 Transmutation [Concentration]
...
# 72. - Steel Whirlwind (M,S) level 5 Conjuration
...
# 73. - Heroic Infusion (V,S) level 6 Transmutation [Concentration]
...
# 74. - Poison Wave (M,V,S) level 6 Evocation
...
# 75. - Raise Spectral Avenger (V,S) level 6 Necromancy [Concentration]

Summons Spectral Avenger:
A powerful, ethereal undead creature.

# 76. - Ring of Blades (M,V,S) level 6 Conjuration [Concentration]
...
# 77. - Raise Wight (V,S) level 7 Necromancy [Concentration]

Summons Wight:
A Wight

# 78. - Reverse Gravity (V,S) level 7 Transmutation [Concentration]

This spell reverses gravity in a 50-foot-radius, 100-foot-high cylinder centered on a point within range.

# 79. - Mind Blank (V,S) level 8 Transmutation
...
# 80. - Raise Wight Lord (V,S) level 8 Necromancy [Concentration]

Summons Wight Lord:
A powerful wight, trained to withstand the light of day.

# 81. - Foresight (V,S) level 9 Transmutation

You touch a willing creature and bestow a limited ability to see into the immediate future. For the duration, the target can't be surprised and has advantage on attack rolls, ability checks, and saving throws. Additionally, other creatures have disadvantage on attack rolls against the target for the duration.

# 82. - Mass Heal (V,S) level 9 Transmutation
...
# 83. - Meteor Swarm [Single Target] (V,S) level 9 Transmutation
...
# 84. - Power Word Heal (V,S) level 9 Enchantment

A wave of healing energy washes over the creature you touch. The target regains all its hit points. If the creature is charmed, frightened, paralyzed, or stunned, the condition ends. If the creature is prone, it can use its reaction to stand up. This spell has no effect on undead or constructs.

# 85. - Power Word Kill (V,S) level 9 Transmutation

You utter a word of power that can compel one creature you can see within range to die instantly. If the creature you choose has 100 hit points or fewer, it dies. Otherwise, the spell has no effect.

# 86. - Shapechange (M,V,S) level 9 Transmutation [Concentration]
...
# 87. - Time Stop (V) level 9 Transmutation

You briefly stop the flow of time for everyone but yourself. No time passes for other creatures, while you take 1d4 + 1 turns in a row, during which you can use actions and move as normal.

# 88. - Weird (V,S) level 9 Illusion [Concentration]
