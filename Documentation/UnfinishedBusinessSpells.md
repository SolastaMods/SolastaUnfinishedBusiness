...
# 70. - *Raulothim's Psychic Lance* © (V) level 4 Enchantment
...
# 73. - *Circle of Power* © (V) level 5 Abjuration [Concentration]
...
# 74. - *Destructive Wave* © (V) level 5 Evocation
...
# 75. - *Far Step* © (V) level 5 Conjuration [Concentration]
...
# 76. - *Immolation* © (V) level 5 Evocation [Concentration]
...
# 79. - *Steel Wind Strike* © (M,S) level 5 Conjuration
...
# 80. - *Telekinesis* © (V,S) level 5 Transmutation [Concentration]
...
# 84. - *Tasha's Otherworldly Guise* © (M,V,S) level 6 Transmutation [Concentration]

Uttering an incantation, you draw on the magic of the Lower Planes or Upper Planes (your choice) to transform yourself.

# 85. - *Tenser's Transformation* © (V,S) level 6 Transmutation [Concentration]
...
# 90. - *Meteor Swarm* © (V,S) level 9 Transmutation
