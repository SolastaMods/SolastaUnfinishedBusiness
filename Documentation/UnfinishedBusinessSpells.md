...
# 3. - Blade Barrier (V,S) level 0 Abjuration

You extend your hand and trace a sigil of warding in the air. Until the end of your next turn, you have resistance against bludgeoning, piercing, and slashing damage dealt by weapon attacks.

# 4. - Burning Blade (M,S) level 0 Evocation
...
# 22. - Elemental Orb (M,V,S) level 1 Evocation

You hurl a 4-inch-diameter sphere of energy at a creature that you can see within range. You choose acid, cold, fire, lightning, poison, or thunder for the type of orb you create, and then make a ranged spell attack against the target. If the attack hits, the creature takes 3d8 damage of the type you chose.

# 23. - Entangling Strike (V) level 1 Conjuration [Concentration]
...
# 24. - Furious Smite (V) level 1 Evocation [Concentration]
...
# 25. - Ice Blade (S) level 1 Conjuration
...
# 26. - Infernal Smite (V) level 1 Evocation [Concentration]
...
# 27. - Intensify Gravity (V,S) level 1 Transmutation

Sharply increase gravity in a 10-foot-radius sphere to crush and slow targets.

# 28. - Mule (V,S) level 1 Transmutation
...
# 31. - Skin of Retribution (V,S) level 1 Abjuration
...
# 32. - Spike Barrage (V) level 1 Conjuration [Concentration]

The next time you hit a creature with a ranged weapon attack before the spell ends, this spell creates a rain of thorns that sprouts from your ranged weapon or ammunition. In addition to the normal effect of the attack, the target of the attack and each creature within 5 feet of it must make a Dexterity saving throw. A creature takes 1d10 piercing damage on a failed save, or half as much damage on a successful one.

# 33. - Summon Familiar (V,S) level 1 Conjuration
...
# 34. - Swift Strike (V) level 1 Transmutation [Concentration]
...
# 35. - Vile Brew (V,S) level 1 Evocation [Concentration]
...
# 36. - Void's Grasp (V,S) level 1 Evocation
...
# 37. - Bounden Ice (S) level 2 Evocation
...
# 38. - Cloud of Blades (V,S) level 2 Conjuration [Concentration]
...
# 40. - Conjure Web (V,S) level 2 Conjuration [Concentration]
...
# 41. - Illusory Duplicates (V,S) level 2 Illusion
...
# 43. - Petal Storm (V,S) level 2 Conjuration [Concentration]
...
# 45. - Psychic Whip (V) level 2 Enchantment
...
# 46. - Raise Skeleton (V,S) level 2 Necromancy [Concentration]
...
# 47. - Raise Skeleton Archer (V,S) level 2 Necromancy [Concentration]

Summons Skeleton Archer:
Skeletons are animated by dark magic. They used to be living creatures but are now empty shells of hate, arisen from tombs or battlefields and craving for life… to kill.

# 48. - Shadow Blade (V,S) level 2 Illusion [Concentration]
...
# 53. - Elemental Enchantment (V,S) level 3 Transmutation [Concentration]
...
# 54. - Fire Arrows (M,V,S) level 3 Transmutation [Concentration]
...
# 55. - Hunger of The Void (V,S) level 3 Transmutation [Concentration]
...
# 56. - Lightning Arrow (V,S) level 3 Transmutation [Concentration]
...
# 57. - Luminous Smite (V) level 3 Evocation [Concentration]
...
# 58. - Pulse Wave (V,S) level 3 Evocation

Hurl enemies away with intense gravitational pressure.

# 59. - Raise Ghoul (V,S) level 3 Necromancy [Concentration]

Summons Ghoul:
A ravenous undead creature, constantly searching for flesh to eat.

# 60. - Spirit Nimbus (V,S) level 3 Necromancy [Concentration]
...
# 61. - Vitality Transfer (V,S) level 3 Necromancy
...
# 63. - Aura of Perseverance (V) level 4 Abjuration [Concentration]
...
# 64. - Aura of Vivacity (V) level 4 Abjuration [Concentration]
...
# 67. - Force Field (V,S) level 4 Evocation
...
# 68. - Irresistible Performance (V) level 4 Enchantment
...
# 69. - Protector of the Wild (V) level 4 Transmutation [Concentration]
...
# 70. - Psychic Lance (V) level 4 Enchantment
...
# 71. - Raise Skeletal Enforcer (V,S) level 4 Necromancy [Concentration]
...
# 73. - Divine Wrath (V) level 5 Evocation
...
# 74. - Ethereal Step (V) level 5 Conjuration [Concentration]
...
# 75. - Expelling Smite (V) level 5 Abjuration [Concentration]
...
# 76. - Incineration (V) level 5 Evocation [Concentration]
...
# 77. - Magical Negation (V) level 5 Abjuration [Concentration]
...
# 78. - Mantle of Thorns (V,S) level 5 Transmutation [Concentration]
...
# 79. - Raise Skeletal Knight (V,S) level 5 Necromancy [Concentration]

Summons Skeletal Knight:
A powerful undead creature, created by raising a dead knight.

# 80. - Raise Skeletal Marksman (V,S) level 5 Necromancy [Concentration]
...
# 82. - Steel Whirlwind (M,S) level 5 Conjuration
...
# 83. - Telekinesis (V,S) level 5 Transmutation
...
# 85. - Heroic Infusion (V,S) level 6 Transmutation [Concentration]
...
# 86. - Mystical Cloak (M,V,S) level 6 Transmutation [Concentration]
...
# 88. - Raise Spectral Avenger (V,S) level 6 Necromancy [Concentration]

Summons Spectral Avenger:
A powerful, ethereal undead creature.

# 89. - Ring of Blades (M,V,S) level 6 Conjuration [Concentration]
...
# 90. - Alter Gravity (V,S) level 7 Transmutation [Concentration]

This spell reverses gravity in a 50-foot-radius, 100-foot-high cylinder centered on a point within range.

# 91. - Raise Wight (V,S) level 7 Necromancy [Concentration]

Summons Wight:
A Wight

# 92. - Mind Ward (V,S) level 8 Transmutation
...
# 98. - Halt Time (V) level 9 Transmutation
...
# 100. - Precognition (V,S) level 9 Transmutation

You touch a willing creature and bestow a limited ability to see into the immediate future. For the duration, the target can't be surprised and has advantage on attack rolls, ability checks, and saving throws. Additionally, other creatures have disadvantage on attack rolls against the target for the duration.

# 101. - Transformation (M,V,S) level 9 Transmutation [Concentration]
