...
# 21. - *Chaos Bolt* © (V,S) level 1 Evocation

You hurl an undulating, warbling mass of chaotic energy at one creature in range. Make a ranged spell attack against the target. On a hit, the target takes 2d8 + 1d6 damage. Choose one of the d8s. The number rolled on that die determines the attack's damage type:
1• Acid
2• Cold
3• Fire
4• Force
...
# 22. - *Chromatic Orb* © (M,V,S) level 1 Evocation
...
# 23. - *Earth Tremor* © (V,S) level 1 Evocation

You strike the ground and unleash a tremor of seismic force, hurling up earth, rock, and sand.

# 24. - *Ensnaring Strike* © (V) level 1 Conjuration [Concentration]
...
# 25. - *Find Familiar* © (V,S) level 1 Conjuration
...
# 26. - *Gift of Alacrity* © (V,S) level 1 Divination

You touch a willing creature. For the duration, the target can add 1d8 to its initiative rolls.

# 27. - *Hail of Thorns* © (V) level 1 Conjuration [Concentration]

The next time you hit a creature with a ranged weapon attack before the spell ends, this spell creates a rain of thorns that sprouts from your ranged weapon or ammunition. In addition to the normal effect of the attack, the target of the attack and each creature within 5 feet of it must make a Dexterity saving throw. A creature takes 1d10 piercing damage on a failed save, or half as much damage on a successful one.

# 28. - *Ice Knife* © (S) level 1 Conjuration
...
# 29. - *Magnify Gravity* © (V,S) level 1 Transmutation

Sharply increase gravity in a 10-foot-radius sphere to crush and slow targets.

# 30. - Mule (V,S) level 1 Transmutation
...
# 31. - Radiant Motes (V,S) level 1 Evocation
...
# 32. - *Sanctuary* © (V,S) level 1 Abjuration
...
# 33. - *Searing Smite* © (V) level 1 Evocation [Concentration]
...
# 34. - *Tasha's Caustic Brew* © (V,S) level 1 Evocation [Concentration]
...
# 35. - *Thunderous Smite* © (V) level 1 Evocation [Concentration]
...
# 36. - *Witch Bolt* © (V,S) level 1 Evocation [Concentration]
...
# 37. - *Wrathful Smite* © (V) level 1 Evocation [Concentration]
...
# 38. - *Zephyr Strike* © (V) level 1 Transmutation [Concentration]
...
# 39. - *Cloud of Daggers* © (V,S) level 2 Conjuration [Concentration]
...
# 40. - Color Burst (V,S) level 2 Illusion
...
# 41. - Conjure Goblinoids (V,S) level 2 Conjuration [Concentration]

Conjures 2 goblins who obey your orders unless you lose concentration.

# 42. - *Mirror Image* © (V,S) level 2 Illusion
...
# 43. - Noxious Spray (V,S) level 2 Evocation
...
# 44. - Petal Storm (V,S) level 2 Conjuration [Concentration]
...
# 45. - Protect Threshold (V,S) level 2 Abjuration
...
# 46. - *Rime's Binding Ice* © (S) level 2 Evocation
...
# 48. - *Tasha's Mind Whip* © (V) level 2 Enchantment
...
# 49. - *Web* © (V,S) level 2 Conjuration [Concentration]
...
# 50. - *Wither and Bloom* © (V,S) level 2 Necromancy
...
# 51. - Adder's Fangs (V,S) level 3 Conjuration
...
# 52. - *Aura of Vitality* © (V) level 3 Evocation [Concentration]

Healing energy radiates from you in an aura with a 30-foot radius. Until the spell ends, the aura moves with you, centered on you. You can use a bonus action to cause one creature in the aura (including you) to regain 2d6 hit points.

# 53. - *Blinding Smite* © (V) level 3 Evocation [Concentration]
...
# 54. - Corrupting Bolt (V,S) level 3 Necromancy
...
# 55. - *Crusader's Mantle* © (V) level 3 Evocation [Concentration]

Surround yourself with a magical aura. Allies within the aura gain a bonus 1d4 radiant damage on their attacks.

# 56. - *Elemental Weapon* © (V,S) level 3 Transmutation [Concentration]
...
# 57. - *Flame Arrows* © (M,V,S) level 3 Transmutation [Concentration]
...
# 58. - *Hunger of Hadar* © (V,S) level 3 Transmutation [Concentration]
...
# 59. - *Life Transference* © (V,S) level 3 Necromancy
...
# 60. - *Lightning Arrow* © (V,S) level 3 Transmutation [Concentration]
...
# 61. - *Pulse Wave* © (V,S) level 3 Evocation

Hurl enemies away with intense gravitational pressure.

# 62. - *Spirit Shroud* © (V,S) level 3 Necromancy [Concentration]
...
# 63. - *Thunder Step* © (V) level 3 Conjuration
...
# 64. - Winter's Breath (V,S) level 3 Conjuration

Create a blast of cold wind to chill your enemies and knock them prone.

# 65. - *Aura of Life* © (V) level 4 Abjuration [Concentration]
...
# 66. - *Aura of Purity* © (V) level 4 Abjuration [Concentration]
...
# 67. - Blessing of Rime (V,S) level 4 Evocation
...
# 68. - Brain Bulwark (V) level 4 Abjuration
...
# 69. - *Gravity Sinkhole* © (V,S) level 4 Evocation
...
# 70. - *Guardian of Nature* © (V) level 4 Transmutation [Concentration]
...
# 71. - Irresistible Performance (V) level 4 Enchantment
...
# 72. - *Mordenkainen's Faithful Hound* © (V,S) level 4 Conjuration
...
# 73. - *Raulothim's Psychic Lance* © (V) level 4 Enchantment
...
# 74. - *Staggering Smite* © (V) level 4 Evocation [Concentration]
...
# 75. - *Banishing Smite* © (V) level 5 Abjuration [Concentration]
...
# 76. - *Circle of Power* © (V) level 5 Abjuration [Concentration]
...
# 77. - *Dawn* © (V,S) level 5 Evocation [Concentration]
...
# 78. - *Destructive Wave* © (V) level 5 Evocation
...
# 79. - *Far Step* © (V) level 5 Conjuration [Concentration]
...
# 80. - *Immolation* © (V) level 5 Evocation [Concentration]
...
# 81. - Mantle of Thorns (V,S) level 5 Transmutation [Concentration]
...
# 82. - Sonic Boom (V,S) level 5 Evocation
...
# 83. - *Steel Wind Strike* © (M,S) level 5 Conjuration
...
# 84. - *Telekinesis* © (V,S) level 5 Transmutation [Concentration]
...
# 85. - *Fizban's Platinum Shield* © (M,V,S) level 6 Abjuration [Concentration]
...
# 86. - Flash Freeze (V,S) level 6 Evocation
...
# 87. - Poison Wave (M,V,S) level 6 Evocation
...
# 89. - *Tasha's Otherworldly Guise* © (M,V,S) level 6 Transmutation [Concentration]

Uttering an incantation, you draw on the magic of the Lower Planes or Upper Planes (your choice) to transform yourself.

# 90. - *Tenser's Transformation* © (V,S) level 6 Transmutation [Concentration]
...
# 91. - *Draconic Transformation* © (M,V,S) level 7 Transmutation [Concentration]
...
# 92. - *Reverse Gravity* © (V,S) level 7 Transmutation [Concentration]

This spell reverses gravity in a 50-foot-radius, 100-foot-high cylinder centered on a point within range.

# 93. - *Maddening Darkness* © (V) level 8 Evocation [Concentration]
...
# 94. - *Mind Blank* © (V,S) level 8 Transmutation
...
# 95. - *Foresight* © (V,S) level 9 Transmutation

You touch a willing creature and bestow a limited ability to see into the immediate future. For the duration, the target can't be surprised and has advantage on attack rolls, ability checks, and saving throws. Additionally, other creatures have disadvantage on attack rolls against the target for the duration.

# 96. - *Mass Heal* © (V,S) level 9 Transmutation
...
# 97. - *Meteor Swarm* © (V,S) level 9 Transmutation
...
# 98. - *Power Word Heal* © (V,S) level 9 Enchantment

A wave of healing energy washes over the creature you touch. The target regains all its hit points. If the creature is charmed, frightened, paralyzed, or stunned, the condition ends. If the creature is prone, it can use its reaction to stand up. This spell has no effect on undead or constructs.

# 99. - *Power Word Kill* © (V,S) level 9 Transmutation

You utter a word of power that can compel one creature you can see within range to die instantly. If the creature you choose has 100 hit points or fewer, it dies. Otherwise, the spell has no effect.

# 100. - *Shapechange* © (M,V,S) level 9 Transmutation [Concentration]
...
# 101. - *Time Stop* © (V) level 9 Transmutation

You briefly stop the flow of time for everyone but yourself. No time passes for other creatures, while you take 1d4 + 1 turns in a row, during which you can use actions and move as normal.

# 102. - *Weird* © (V,S) level 9 Illusion [Concentration]
