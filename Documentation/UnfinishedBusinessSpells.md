...
# 3. - Banishing Smite (V) level 5 Abjuration
...
# 5. - Blinding Smite (V) level 3 Evocation
...
# 6. - Booming Blade (M,S) level 0 Evocation
...
# 7. - Bounden Ice (S) level 2 Evocation
...
# 8. - Brain Bulwark (V) level 4 Abjuration
...
# 9. - Burning Blade (M,S) level 0 Evocation
...
# 10. - Burst of Radiance (V) level 0 Evocation

Create a brilliant flash of shimmering light, damaging all enemies around you.

# 11. - Caustic Zap (V,S) level 1 Evocation
...
# 12. - Celerity Boon (V,S) level 1 Divination

You touch a willing creature. For the duration, the target can add 1d8 to its initiative rolls.

# 13. - Chromatic Orb (M,V,S) level 1 Evocation

You hurl a 4-inch-diameter sphere of energy at a creature that you can see within range. You choose acid, cold, fire, lightning, poison, or thunder for the type of orb you create, and then make a ranged spell attack against the target. If the attack hits, the creature takes 3d8 damage of the type you chose.

# 14. - Color Burst (V,S) level 2 Illusion
...
# 18. - Enduring Sting (V,S) level 0 Necromancy

You sap the vitality of one creature you can see in range. The target must succeed on a Constitution saving throw or take 1d4 necrotic damage and fall prone.

# 19. - Ensnaring Strike (V) level 1 Conjuration
...
# 20. - Ethereal Knell (V,S) level 0 Necromancy

You point at one creature you can see within range, and the sound of a dolorous bell fills the air around it for a moment. The target must succeed on a Wisdom saving throw or take 1d8 necrotic damage. If the target is missing any of its hit points, it instead takes 1d12 necrotic damage.

# 21. - Far Step (V) level 5 Conjuration
...
# 23. - Foresight (V,S) level 9 Transmutation

You touch a willing creature and bestow a limited ability to see into the immediate future. For the duration, the target can't be surprised and has advantage on attack rolls, ability checks, and saving throws. Additionally, other creatures have disadvantage on attack rolls against the target for the duration.

# 24. - Gone with The Wind (V) level 1 Transmutation
...
# 25. - Gravity Sinkhole (V,S) level 4 Evocation

Draw enemies together and crush them with gravitational energy.

# 26. - Illuminating Sphere (V,S) level 0 Enchantment
...
# 28. - Mantle of Thorns (V,S) level 5 Transmutation
...
# 29. - Mass Heal (V,S) level 9 Transmutation
...
# 30. - Meteor Swarm [Single Target] (V,S) level 9 Transmutation
...
# 31. - Mind Blank (V,S) level 8 Transmutation
...
# 33. - Minor Lifesteal (V,S) level 0 Necromancy
...
# 34. - Mirror Image (V,S) level 2 Illusion
...
# 35. - Mule (V,S) level 1 Transmutation
...
# 37. - Power Word Heal (V,S) level 9 Enchantment

A wave of healing energy washes over the creature you touch. The target regains all its hit points. If the creature is charmed, frightened, paralyzed, or stunned, the condition ends. If the creature is prone, it can use its reaction to stand up. This spell has no effect on undead or constructs.

# 38. - Power Word Kill (V,S) level 9 Transmutation
...
# 40. - Pulse Wave (V,S) level 3 Evocation

Hurl enemies away with intense gravitational pressure.

# 41. - Radiant Motes (V,S) level 1 Evocation
...
# 56. - Skin of Retribution (V,S) level 1 Abjuration
...
# 57. - Sonic Boom (V,S) level 5 Evocation
...
# 58. - Sound Burst (V,S) level 0 Evocation
...
# 61. - Staggering Smite (V) level 4 Evocation
...
# 62. - Sunlit Blade (M,S) level 0 Evocation
...
# 63. - Sword Storm (V,S) level 0 Enchantment
...
# 64. - Thorny Vines (V,S) level 0 Transmutation
...
# 65. - Thunderous Smite (V) level 1 Evocation
...
# 66. - Time Stop (V) level 9 Transmutation

You briefly stop the flow of time for everyone but yourself. No time passes for other creatures, while you take 1d4 + 1 turns in a row, during which you can use actions and move as normal.

# 67. - Web (V,S) level 2 Conjuration
...
# 71. - Wrathful Smite (V) level 1 Evocation
